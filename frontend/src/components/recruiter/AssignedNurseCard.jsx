 ...
 */
export default function AssignedNurseCard({ nurse, onViewProfile, compact = false }) {
    ...
    >
      ...
      {onViewProfile && (
        <button
          ...
          className="mt-2 w-full text-xs font-semibold text-indigo-700 py-2 rounded-lg bg-white/80 border border-green-100 hover:bg-white"
        >
          View profile
        </button>
      )}
